...
PlotDist = Plot[PDF[MixedDist,x],{x,0,10},
PlotLabel->"Mixed Gaussian Distribution",
AxesLabel->{"x","Density"},
Filling->Axis];

PlotDists = Show[PlotDist,
ListPlot[Transpose[{DataMixed,ConstantArray[0, Length[DataMixed]]}],
...
KDERPlot = Plot[KDER[x,h,DataMixed],{x,0,10},
PlotPoints->3000,
MaxRecursion->4,

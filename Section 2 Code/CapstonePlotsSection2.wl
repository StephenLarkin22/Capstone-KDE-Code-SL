...
PlotLegends->{Style[TraditionalForm[f[x]], 14]},
...
AxesLabel->{"x","Probability Density"},
PlotLegends->{Style[TraditionalForm[F[x]], 14]}],ListStepPlot[FnDataExtended,PlotStyle->{Red,Thickness[0.003]},PlotRange->{0,1}, PlotLegends->{Style[TraditionalForm[Subscript[F, "n"][x]], 14]}]]
